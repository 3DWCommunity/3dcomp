...
namespace al {
    ...
    HitSensor* HitSensorKeeper::addSensor(LiveActor* pActor, const char* pName, u32 unk, f32 range, u16 unk2, const sead::Vector3f* pFollowVec,
                                          const sead::Matrix34f* pFollowMtx, const sead::Vector3f& rOffs) {
