...
namespace al {
    ...
    void AreaObj::init(const AreaInitInfo& rInfo) {
        ...
        al::tryGetArg(&mIsPlessieChaseV2SpecialCamera, *mPlacementInfo, "IsPlessieChaseV2SpecialCamera");
        ...
        bool listenStageSwitch = al::listenStageSwitchOnOffAppear(this, Functor(this, &AreaObj::validate),
